...
namespace GUIapp
{
  ...
  public abstract class GuiDecorator : GuiElement//MISSING CODE - DONE - Added : GuiElement + see code below!
  {
      public GuiDecorator(Point top_left_corner) : base(top_left_corner)
      {
      }
